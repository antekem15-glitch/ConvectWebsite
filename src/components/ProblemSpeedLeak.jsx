...
export default function ProblemSpeedLeak() {
  const niches = [
    ...
    },
    {
      ...
      step: 500,
      lostDealsMonth: 2,
      scenario: 'Selbstzahler erreichen nur die Warteschleife oder lassen Termine ohne SMS-Erinnerung platzen.',
    },
    {
      id: 'immo',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 p-6 sm:p-8 rounded-2xl bg-[#1E293B] border border-slate-800 shadow-2xl text-left">
            <div className="flex items-center justify-between border-b border-slate-800 pb-4 mb-6">
              <h3 className="text-lg font-bold text-white">Rechnen Sie den Ausfall vor:</h3>
            ...
            <div className="space-y-6">
              ...
              <div>
                <div className="flex justify-between text-sm mb-2 font-medium">
                  <label htmlFor="ticket-slider" className="text-slate-200">
                    2. Ihr Deckungsbeitrag / Auftragswert:
                  </label>
                  <span className="text-emerald-400 font-bold text-base">{formatEuro(ticketValue)}</span>
                </div>
                {/* Barrierefreier Slider mit ID & aria-label */}
                <input
                  id="ticket-slider"
              ...
              <div>
                <div className="flex justify-between text-sm mb-2 font-medium">
                  <span className="text-slate-200">3. Verpasste Anfragen / No-Shows im Monat:</span>
                  <span className="text-red-400 font-bold text-base">
                    {lostPerMonth} {lostPerMonth === 1 ? 'Auftrag' : 'Aufträge'}
                  </span>
                </div>
              ...
              <div className="p-5 rounded-xl bg-red-950/25 border border-red-900/40 space-y-3">
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <span className="text-xs text-slate-300 block">Jeden Monat:</span>
